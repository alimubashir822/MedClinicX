...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculators/metabolic-age-calculator/",
  },
  openGraph: {
    title: "Metabolic Age Calculator - Estimate Your Body’s Metabolic Age & Health Level | Med Clinic X",
    description:
...
export default function MetabolicAgeCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Metabolic Age Calculator", item: "https://medclinicx.com/calculators/metabolic-age-calculator/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                {calculatorData
                  .filter((c) => c.id !== "metabolic-age-calculator")
                  .sort((a, b) => {
                    const currentCat = calculatorData.find((c) => c.id === "metabolic-age-calculator")?.category;
