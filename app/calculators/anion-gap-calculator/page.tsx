...
export default function AnionGapCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Anion Gap Calculator", item: "https://medclinicx.com/calculators/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                {calculatorData
                  .filter((c) => c.id !== "anion-gap-calculator")
                  .sort((a, b) => {
                    const currentCat = calculatorData.find((c) => c.id === "anion-gap-calculator")?.category;
