...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculators/glasgow-coma-scale-calculator/",
  },
  openGraph: {
    title: "Glasgow Coma Scale Calculator - Calculate GCS Score for Consciousness Assessment | Med Clinic X",
    description:
...
export default function GlasgowComaScaleCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Glasgow Coma Scale Calculator", item: "https://medclinicx.com/calculators/glasgow-coma-scale-calculator/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                {calculatorData
                  .filter((c) => c.id !== "glasgow-coma-scale-calculator")
                  .sort((a, b) => {
                    const currentCat = calculatorData.find((c) => c.id === "glasgow-coma-scale-calculator")?.category;
