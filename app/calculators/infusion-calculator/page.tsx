...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculators/infusion-calculator/",
  },
  openGraph: {
    title: "Infusion Calculator - Calculate IV Infusion Rate, Volume & Flow Speed (mL/hr & gtt/min) | Med Clinic X",
    description:
...
export default function InfusionCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Infusion Calculator", item: "https://medclinicx.com/calculators/infusion-calculator/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                {calculatorData
                  .filter((c) => c.id !== "infusion-calculator")
                  .sort((a, b) => {
                    const currentCat = calculatorData.find((c) => c.id === "infusion-calculator")?.category;
