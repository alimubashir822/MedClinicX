...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculators/cpt-calculator/",
  },
  openGraph: {
    title: "CPT Calculator - Calculate CPT Codes, Billing Estimates & Healthcare Procedure Costs | Med Clinic X",
    description:
...
export default function CPTCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "CPT Calculator", item: "https://medclinicx.com/calculators/cpt-calculator/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                {calculatorData
                  .filter((c) => c.id !== "cpt-calculator")
                  .sort((a, b) => {
                    const currentCat = calculatorData.find((c) => c.id === "cpt-calculator")?.category;
