...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculators/iv-flow-rate-calculator/",
  },
  openGraph: {
    title: "IV Flow Rate Calculator - Calculate IV Infusion Rate, mL/hr & Drops Per Minute | Med Clinic X",
    description:
...
export default function IVFlowRateCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "IV Flow Rate Calculator", item: "https://medclinicx.com/calculators/iv-flow-rate-calculator/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                {calculatorData
                  .filter((c) => c.id !== "iv-flow-rate-calculator")
                  .sort((a, b) => {
                    const currentCat = calculatorData.find((c) => c.id === "iv-flow-rate-calculator")?.category;
