...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "Cloud Platforms (AWS/Azure/GCP)", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "Containerization (Docker & Kubernetes)", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    ...
    { name: "Linux System Administration", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "Networking (DNS, ALB, VPC)", level: "Highly Valued", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "Monitoring (Prometheus, Grafana)", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS Platforms", desc: "Design high-availability cloud configurations hosting patient portal databases.", icon: <Globe className="w-5 h-5" /> },
    { title: "Cloud-Native Infrastructure", desc: "Deploy multi-AZ container topologies that scale dynamically under high loads.", icon: <Database className="w-5 h-5" /> },
    { title: "EHR/EMR Integration Systems", desc: "Provision load balancers and secure reverse-proxies separating internal EHR feeds.", icon: <Layers className="w-5 h-5" /> },
    { title: "AI Healthcare Infrastructure", desc: "Configure cluster nodes and autoscaling policies for machine learning models.", icon: <Brain className="w-5 h-5" /> },
    { title: "Telemedicine Platforms", desc: "Optimize network bandwidth, connection stability, and media proxy configurations.", icon: <HeartPulse className="w-5 h-5" /> },
    { title: "Patient Data Systems", desc: "Enforce network boundary locks and KMS encryption settings on patient datasets.", icon: <Server className="w-5 h-5" /> },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-cyan/15 to-brand-indigo/15 border border-brand-cyan/20 rounded-full px-4 py-1.5 shadow-lg shadow-brand-cyan/5">
                  ...
                  <span className="text-[10px] font-bold text-brand-cyan uppercase tracking-widest">Platform Engineering</span>
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Design, build, and maintain scalable cloud-native infrastructure for healthcare SaaS and digital health platforms. Enable high availability, manage auto-scalers, and write IaC deployment codes.
                </p>
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Med Clinic X is a healthcare technology company building modern, scalable, and secure digital systems that power healthcare organizations across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We develop healthcare SaaS platforms, AI-driven healthcare systems, patient portals, telemedicine solutions, automation workflows, and cloud-native digital health infrastructure for clinics, hospitals, and healthcare providers.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to build reliable, high-performance infrastructure that ensures healthcare systems run securely and at scale.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are seeking an <strong>Infrastructure Engineer</strong> to design, build, and maintain scalable infrastructure for healthcare SaaS and digital health platforms.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will ensure that healthcare systems remain highly available, performant, and secure across cloud environments used by organizations in the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will work closely with DevOps, cloud, and engineering teams to support production systems that power critical healthcare workflows.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Infrastructure Design & Management</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Design scalable cloud infrastructure for SaaS platforms.</li>
                        <li>Manage staging, testing, and production cloud topologies.</li>
                        <li>Ensure high availability, scaling, and system fault tolerance.</li>
                        <li>Optimize cloud performance and calculate cost-efficiency guides.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Healthcare Platform Support</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Support EMR databases and secure patient intake portals.</li>
                        <li>Configure network load balancing and DNS parameters.</li>
                        <li>Manage traffic surges and scale EC2/EKS resources.</li>
                        <li>Support container configurations for AI machine learning nodes.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Cloud & DevOps Collaboration</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Work with DevOps engineers to refine automated deployments.</li>
                        <li>Manage container clusters (Docker, Kubernetes).</li>
                        <li>Automate resources using Terraform IaC templates.</li>
                        <li>Configure Prometheus/Grafana metric alerts.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Implement security hardening controls across all VPC subnets.</li>
                        <li>Ensure cloud networks comply with HIPAA rules.</li>
                        <li>Map out secure user roles and encrypt database volumes.</li>
                        <li>Harden container configurations against common vulnerabilities.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-300">
                    <div className="space-y-3">
                      ...
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        <li>Bachelor’s degree in CS, IS, Software Engineering, or related field.</li>
                        <li>Experience in cloud infrastructure engineering, DevOps, or systems scaling.</li>
                        <li>Solid expertise in AWS, Azure, or GCP platform components.</li>
                        <li>Strong Linux system administration and shell scripting skills.</li>
                        <li>Proficiency in Infrastructure as Code (Terraform) and Git workflows.</li>
                      </ul>
                    </div>
                    <div className="space-y-3">
                      ...
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        ...
                        <li>Familiarity with HIPAA compliance requirements and network rules.</li>
                        <li>Experience managing production Kubernetes (EKS/AKS) at enterprise scale.</li>
                        <li>Exposure to AI/ML infrastructure environments.</li>
                        <li>Understanding of disaster recovery processes and active-active setups.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will build the backbone of modern healthcare technology. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Design infrastructure for mission-critical healthcare systems</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Support scalable SaaS and AI healthcare platforms</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Collaborate with elite cloud, DevOps, and engineering teams</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Contribute to digital transformation in US healthcare operations</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Thank you for demonstrating your technical understanding of multi-AZ database clustering, dynamic Kubernetes auto-scaling parameters, and GitOps Terraform plan workflows.
                        </p>
                      </div>
                    ...
                    <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="ethan.infra@example.com"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="https://github.com/ethaninfra"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {/* STEP 2: Infrastructure Experience */}
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">Infrastructure Profile</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary Infrastructure as Code (IaC) Tool</label>
                              <select
                                value={formData.primaryIaC}
                                onChange={(e) => setFormData(prev => ({ ...prev, primaryIaC: e.target.value }))}
                              ...
                              >
                                <option value="terraform">HashiCorp Terraform (recommended)</option>
                                <option value="cloudformation">AWS CloudFormation</option>
                                <option value="pulumi">Pulumi (Typescript/Python)</option>
                                <option value="ansible">Ansible Playbooks</option>
                              </select>
                            </div>

                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of Infrastructure / DevOps Experience</label>
                              <select
                                value={formData.infraYears}
                                onChange={(e) => setFormData(prev => ({ ...prev, infraYears: e.target.value }))}
                                className="w-full bg-brand-bg border border-brand-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan transition-colors"
                              >
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable writing clean dynamic auto-scaling rules under AWS Autoscaling Groups?</label>
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">Infrastructure Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">Primary IaC:</span>{" "}
                                <span className="capitalize">{formData.primaryIaC}</span>
                              </p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">Infra Experience:</span> {formData.infraYears} years</p>
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  ...
                                  <span>Submit Infrastructure Application</span>
                                </>
                              )}
                            </button>
                          </div>
