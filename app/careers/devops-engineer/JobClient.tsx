...
import {
  ...
  Lock, Globe, Database, Server,
  Check, Send, Code, AlertCircle, Cpu, RefreshCw
} from "lucide-react";
...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "CI/CD & Deployment Automation", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "Docker & Kubernetes Orchestration", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    ...
    { name: "AWS, Azure, or GCP Cloud Environments", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "Prometheus, Grafana, & Alerting", level: "Highly Valued", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "HIPAA Compliance & Identity Controls", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS platforms", desc: "Automate reliable multi-tenant deployments and microservice rollouts.", icon: <Globe className="w-5 h-5" /> },
    { title: "Cloud infrastructure systems", desc: "Manage highly available Kubernetes node groups and VPC architectures.", icon: <Server className="w-5 h-5" /> },
    { title: "CI/CD automation pipelines", desc: "Build vulnerability-checking push pipelines for developers.", icon: <Code className="w-5 h-5" /> },
    { title: "AI healthcare systems", desc: "Coordinate MLOps tooling and pipeline run automation for model training.", icon: <Brain className="w-5 h-5" /> },
    { title: "Telemedicine platforms", desc: "Optimize logging, monitoring, and tracing to detect and repair call drops.", icon: <HeartPulse className="w-5 h-5" /> },
    { title: "EHR/EMR integrations", desc: "Maintain data pipeline connectivity health and webhook listener systems.", icon: <Database className="w-5 h-5" /> },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-cyan/15 to-brand-indigo/15 border border-brand-cyan/20 rounded-full px-4 py-1.5 shadow-lg shadow-brand-cyan/5">
                  ...
                  <span className="text-[10px] font-bold text-brand-cyan uppercase tracking-widest">DevOps Career</span>
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Design, build, and maintain scalable infrastructure and automation systems for healthcare SaaS and digital health platforms. Lead deployment reliability and CI/CD pipelines.
                </p>
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Med Clinic X is a healthcare technology company building modern cloud-native and AI-powered systems that support healthcare organizations across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We develop healthcare SaaS platforms, patient portals, AI-driven healthcare systems, telemedicine solutions, automation workflows, and scalable digital health infrastructure for clinics, hospitals, and healthcare providers.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to build secure, reliable, and automated infrastructure that powers the next generation of healthcare technology.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are seeking a <strong>DevOps Engineer</strong> to design, build, and maintain scalable infrastructure and automation systems for healthcare SaaS and digital health platforms.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will be responsible for CI/CD pipelines, cloud infrastructure, deployment automation, system reliability, and performance optimization of healthcare applications used across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will collaborate with engineering, cloud, and AI teams to ensure smooth deployment and operation of mission-critical healthcare systems.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">CI/CD & Automation</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Build and maintain secure CI/CD pipelines.</li>
                        <li>Automate staging & production deployment workflows.</li>
                        <li>Optimize microservice release iterations.</li>
                        <li>Implement progressive rollouts and rollback triggers.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Cloud & Kubernetes</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Manage cloud networks in AWS, Azure, or GCP.</li>
                        <li>Support Docker and Kubernetes platforms.</li>
                        <li>Design scalable, multi-tenant databases.</li>
                        <li>Optimize infrastructure cost and throughput metrics.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">SRE & Monitoring</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Ensure high availability of telemedicine/SaaS engines.</li>
                        <li>Deploy Prometheus, Grafana, and tracing tools.</li>
                        <li>Audit system bottlenecks and debug microservice lags.</li>
                        <li>Configure alerting policies for pager alerts.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Security & Compliance</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Design secure networks complying with HIPAA.</li>
                        <li>Audit platform vulnerabilities and Docker configurations.</li>
                        <li>Deploy automated secret and credential rotations.</li>
                        <li>Maintain identity bounds and access permissions.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will build and maintain infrastructure that powers modern healthcare systems. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Automate deployment of healthcare SaaS platforms</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Support AI and data-driven healthcare systems</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Improve reliability of critical healthcare applications</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Work with modern cloud-native technologies</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Thank you for demonstrating your deployment automation and container orchestrating skills. This mock setup validates your ability to configure HIPAA-compliant pipelines.
                        </p>
                      </div>
                    ...
                    <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="https://github.com/marcust"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {/* STEP 2: DevOps Experience */}
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">DevOps & Automation Experience</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary CI/CD Platform</label>
                              <select
                                value={formData.cicdTool}
                                onChange={(e) => setFormData(prev => ({ ...prev, cicdTool: e.target.value }))}
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of experience in DevOps or SRE roles</label>
                              <select
                                value={formData.devopsYears}
                                onChange={(e) => setFormData(prev => ({ ...prev, devopsYears: e.target.value }))}
                                className="w-full bg-brand-bg border border-brand-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan transition-colors"
                              >
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable configuring multi-node Kubernetes container groups and auto-scalers?</label>
                              <div className="flex gap-4">
                                {["yes", "no"].map((val) => (
                                  <button
                                    key={val}
                                    type="button"
                                    onClick={() => setFormData(prev => ({ ...prev, k8sFamiliar: val }))}
                                    className={`flex-1 border text-sm font-semibold py-2.5 rounded-xl capitalize transition-all cursor-pointer ${
                                      formData.k8sFamiliar === val
                          ...
                          <div className="pt-4 flex justify-between">
                            ...
                            >
                              <span>Proceed to Deployment Sandbox</span>
                              <ArrowRight className="w-3.5 h-3.5" />
                            </button>
                          </div>
                        </div>
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">DevOps Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">CI/CD Tool:</span>{" "}
                                <span className="capitalize">{formData.cicdTool}</span>
                              </p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">DevOps Experience:</span> {formData.devopsYears} years</p>
                            ...
                            >
                              {isSubmitting ? (
                                <>
                                  ...
                                  <span>Testing pipelines...</span>
                                </>
                              ) : (
                                <>
                                  <Send className="w-3.5 h-3.5" />
                                  <span>Submit DevOps Application</span>
                                </>
                              )}
                            </button>
                          </div>
