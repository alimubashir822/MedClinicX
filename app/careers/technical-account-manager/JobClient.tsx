...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "Technical Account Management", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "API & System Integration", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    { name: "EHR/EMR (FHIR & HL7) Concepts", level: "Required", color: "text-brand-emerald bg-brand-emerald/10 border-brand-emerald/20" },
    { name: "CRM Platforms (Salesforce/HubSpot)", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "Enterprise Customer Success", level: "Required", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "Cloud & Devops Architecture", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS Platforms", desc: "Manage onboarding operations for hospital systems adopting clinic-wide portals.", icon: <Globe className="w-5 h-5" /> },
    { title: "Patient Portal Systems", desc: "Guide client technical teams through user account authentication configurations.", icon: <Layers className="w-5 h-5" /> },
    { title: "EHR/EMR Integrations", desc: "Coordinate Epic/Cerner API hooks and FHIR resource integrations.", icon: <Database className="w-5 h-5" /> },
    { title: "Clinical Workflow Systems", desc: "Align software configurations with daily medical practitioner schedules.", icon: <Activity className="w-5 h-5" /> },
    { title: "AI Healthcare Solutions", desc: "Coordinate deployment updates for automated patient triage receptionists.", icon: <Sparkles className="w-5 h-5" /> },
    { title: "Digital Health Enterprise Systems", desc: "Monitor SLA latency metrics and lead regular client system health reviews.", icon: <Server className="w-5 h-5" /> },
  ];
  ...
  const validateSandbox = () => {
    ...
    const correctMigration = sandboxSetup.dataMigration === "synthesized_secure_import";
    const correctEscalation = sandboxSetup.slaEscalation === "sla_triage_routing";
    const correctOAuth = sandboxSetup.oauthConfig === "oauth_tenant_isolation";
    
    if (correctMigration && correctEscalation && correctOAuth) {
      setSandboxSuccess(true);
      setSandboxError("");
    } else {
      setSandboxSuccess(false);
      let incorrectCount = 0;
      if (!correctMigration) incorrectCount++;
      if (!correctEscalation) incorrectCount++;
      if (!correctOAuth) incorrectCount++;
      
      setSandboxError(
        `Onboarding audit failed. ${incorrectCount}/3 configurations are non-optimal. Hint: Ensure HIPAA-safe dry runs by mapping synthesized records; coordinate quick SLA incident logs with routing directly to engineering; and set up tenant-isolated, dynamic public-key OAuth clients for patient endpoint security.`
      );
    }
  };
    ...
    <div className="relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="mb-8 flex items-center space-x-2 text-xs">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-white">Technical Account Manager</span>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-cyan/15 to-brand-indigo/15 border border-brand-cyan/20 rounded-full px-4 py-1.5 shadow-lg shadow-brand-cyan/5">
                  ...
                  <span className="text-[10px] font-bold text-brand-cyan uppercase tracking-widest">Enterprise Success</span>
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Oversee technical onboarding, manage enterprise client relationships, troubleshoot integrations, and ensure success of healthcare SaaS products.
                </p>
            ...
            {activeTab === "description" ? (
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We develop healthcare SaaS platforms, AI-driven healthcare systems, patient portals, telemedicine solutions, automation workflows, and integrated digital health products for clinics, hospitals, and healthcare providers.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to ensure seamless adoption, integration, and success of our healthcare technology solutions across client organizations.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are seeking a <strong>Technical Account Manager</strong> to manage client relationships, oversee technical onboarding, and ensure successful adoption of healthcare SaaS platforms.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will act as the primary technical point of contact for healthcare organizations across the United States, helping them implement, integrate, and optimize Med Clinic X solutions.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will bridge the gap between clients and engineering teams to ensure smooth deployment and long-term customer success.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Client Success & Account Management</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Manage relationships with healthcare clients and organizations.</li>
                        <li>Ensure successful onboarding and adoption of SaaS platforms.</li>
                        <li>Understand client needs and translate them into technical requirements.</li>
                        <li>Maintain long-term client satisfaction and retention.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Technical Implementation & Integration</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Support integration of healthcare SaaS with client systems.</li>
                        <li>Assist with API configurations and EHR/EMR integrations.</li>
                        <li>Troubleshoot technical issues during implementation.</li>
                        <li>Coordinate with engineering teams for complex solutions.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Healthcare System Optimization</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Optimize platform usage for healthcare workflows.</li>
                        <li>Ensure clients are using features effectively.</li>
                        <li>Provide guidance on system configuration and best practices.</li>
                        <li>Improve client operational efficiency through technology.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Work closely with product, engineering, and support teams.</li>
                        <li>Communicate client feedback to internal teams.</li>
                        <li>Track implementation progress and success metrics.</li>
                        <li>Ensure timely resolution of technical issues.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-300">
                    <div className="space-y-3">
                      ...
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        <li>Bachelor’s degree in CS, Info Systems, Business, or related field.</li>
                        <li>Experience in technical account management, customer success, or SaaS implementation.</li>
                        <li>Strong understanding of software systems, REST APIs, and database structures.</li>
                        <li>Excellent communication and client-facing presentation skills.</li>
                        <li>Proven track record managing multiple enterprise accounts simultaneously.</li>
                      </ul>
                    </div>
                    <div className="space-y-3">
                      ...
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        ...
                        <li>Familiarity with HIPAA compliance and healthcare data systems (FHIR, HL7).</li>
                        <li>Experience troubleshooting EMR/EHR system integrations.</li>
                        <li>Background in technical support, solutions engineering, or implementation.</li>
                        <li>Experience working with enterprise clinical clients and hospitals.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will ensure healthcare organizations successfully adopt and scale modern digital systems. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Work directly with US healthcare organizations</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Support implementation of SaaS and AI healthcare platforms</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Bridge technical and business teams</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Build a career in healthcare technology success and delivery</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Your customer success onboarding score is logged. We verified your secure FHIR migrations, Sev-1 incident SLA escalation pathways, and tenant-isolated client OAuth authentication configs.
                        </p>
                      </div>
                      ...
                      <button
                        onClick={() => {
                          ...
                          setSandboxSetup({ dataMigration: "", slaEscalation: "", oauthConfig: "" });
                          setFormData({
                            name: "",
                            email: "",
                            portfolioUrl: "",
                    ...
                    <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="oliver.tam@example.com"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>

                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">LinkedIn / Portfolio URL</label>
                              <input
                                type="url"
                                value={formData.portfolioUrl}
                                onChange={(e) => setFormData(prev => ({ ...prev, portfolioUrl: e.target.value }))}
                                placeholder="https://linkedin.com/in/olivertam"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {/* STEP 2: TAM Experience */}
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">Technical Success Profile</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary Enterprise CRM Tool</label>
                              <select
                                value={formData.primaryCRM}
                                onChange={(e) => setFormData(prev => ({ ...prev, primaryCRM: e.target.value }))}
                              ...
                              >
                                ...
                                <option value="hubspot">HubSpot CRM & Service Hub</option>
                                <option value="gainsight">Gainsight CS Platform</option>
                                <option value="jira">Jira Service Management</option>
                              </select>
                            </div>

                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of TAM / Client Onboarding Experience</label>
                              <select
                                value={formData.tamYears}
                                onChange={(e) => setFormData(prev => ({ ...prev, tamYears: e.target.value }))}
                                className="w-full bg-brand-bg border border-brand-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan transition-colors"
                              >
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable troubleshooting FHIR sync failures and OAuth 2.0 token locks?</label>
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          <div className="flex justify-between items-start">
                            <div>
                              <h3 className="font-display font-extrabold text-lg text-white">Client Onboarding & SLA Triage Sandbox</h3>
                              <p className="text-xs text-gray-400 mt-1">
                                Secure client data migrations, configure incident response escalations, and audit EHR API authorizations.
                              </p>
                            </div>
                          ...
                          <div className="space-y-4 font-sans text-xs">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-3">
                              <div className="font-mono text-white text-xs font-semibold flex items-center space-x-2">
                                ...
                                <span>Parameter 1: Onboarding Client Data Migration</span>
                              </div>
                              <p className="text-gray-400 italic text-[11px] leading-relaxed">
                                &quot;How should a new hospital client's legacy patient record base be migrated to staging during kickoff?&quot;
                              </p>
                              <div>
                                <select
                                  value={sandboxSetup.dataMigration}
                                  onChange={(e) => setSandboxSetup(prev => ({ ...prev, dataMigration: e.target.value }))}
                                ...
                                >
                                  <option value="">-- Choose Migration Strategy --</option>
                                  <option value="synthesized_secure_import">Perform dry-run database migrations using synthesized records to map client schemas into Med Clinic X FHIR structures (Correct!)</option>
                                  <option value="unencrypted_csv_sftp">Have the client email unencrypted patient CSV rosters over public threads for rapid upload to staging</option>
                                  <option value="direct_production_overwrite">Directly overwrite the production database tables with the client's raw SQL dump files</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-3">
                              <div className="font-mono text-white text-xs font-semibold flex items-center space-x-2">
                                ...
                                <span>Parameter 2: Client SLA SLA Triage & Severity-1 Escalation</span>
                              </div>
                              <p className="text-gray-400 italic text-[11px] leading-relaxed">
                                &quot;Under SLA parameters, what is the optimal path when a client logs a Severity-1 portal synchronization blackout?&quot;
                              </p>
                              <div>
                                <select
                                  value={sandboxSetup.slaEscalation}
                                  onChange={(e) => setSandboxSetup(prev => ({ ...prev, slaEscalation: e.target.value }))}
                                  className="w-full bg-brand-bg border border-brand-border rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-brand-cyan"
                                >
                                  <option value="">-- Choose Incident Escalation --</option>
                                  <option value="sla_triage_routing">Acknowledge Sev-1 API outages within 15 minutes, gather payload logs, and assign to backend engineering (Correct!)</option>
                                  <option value="auto_responder">Setup a standard email auto-responder informing patients that the team will check issues in the next weekly sprint</option>
                                  <option value="restart_containers">Manually restart client database containers before investigating request errors or logging alerts</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-3">
                              <div className="font-mono text-white text-xs font-semibold flex items-center space-x-2">
                                ...
                                <span>Parameter 3: EHR API Integrations & OAuth Credentials Audit</span>
                              </div>
                              <p className="text-gray-400 italic text-[11px] leading-relaxed">
                                &quot;How should external API client logins be authenticated to prevent data breaches between competing clinic tenants?&quot;
                              </p>
                              <div>
                                <select
                                  value={sandboxSetup.oauthConfig}
                                  onChange={(e) => setSandboxSetup(prev => ({ ...prev, oauthConfig: e.target.value }))}
                                  className="w-full bg-brand-bg border border-brand-border rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-brand-cyan"
                                >
                                  <option value="">-- Choose Client Authorization --</option>
                                  <option value="oauth_tenant_isolation">Configure tenant-isolated OAuth 2.0 clients with dynamic public-key authentication for EHR endpoints (Correct!)</option>
                                  <option value="global_api_token">Issue a single high-privilege global API credential to all clients to bypass onboarding sync limits</option>
                                  <option value="disable_auth_test">Temporarily disable client API request authentication during staging validation tests</option>
                                </select>
                              </div>
                            </div>
                          </div>
                          ...
                          {sandboxSuccess && (
                            <div className="flex items-start space-x-2.5 p-3.5 bg-brand-emerald/10 border border-brand-emerald/20 text-brand-emerald rounded-xl text-xs">
                              ...
                              <span>TAM pre-screen audits completed! Synthesized dry-run migrations verified, Sev-1 incident pathways set, and tenant-isolated OAuth configurations approved.</span>
                            </div>
                          )}
                          ...
                          <div className="pt-4 flex justify-between">
                            ...
                            {!sandboxSuccess ? (
                              <button
                                ...
                                className="inline-flex items-center space-x-2 bg-brand-cyan text-brand-bg font-bold px-5 py-3 rounded-xl hover:opacity-90 transition-opacity text-xs cursor-pointer"
                              >
                                <span>Audit Client Architecture ({sandboxAttempts} attempts)</span>
                              </button>
                            ) : (
                              <button
                                type="button"
                      ...
                      {formStep === 4 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">Account Success Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">CRM tool:</span>{" "}
                                <span className="capitalize">{formData.primaryCRM}</span>
                              </p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">Experience:</span> {formData.tamYears} years</p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">FHIR Comfort:</span> {formData.hipaaFamiliar}</p>
                            </div>
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-1.5">
                              ...
                              <p className="text-brand-emerald flex items-center space-x-1.5">
                                ...
                                <span>Dry-run migrations, 15-minute SLA incident triage metrics, and isolated OAuth 2.0 authentications validated</span>
                              </p>
                            </div>
                          </div>
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  ...
                                  <span>Submit TAM Application</span>
                                </>
                              )}
                            </button>
                          </div>
