...
import {
  ...
  Check, Send, Code, AlertCircle, Eye, EyeOff
} from "lucide-react";
...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "Figma UX/UI Design", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "Design Systems & Tokens", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    { name: "Healthcare Workflow UX Mapping", level: "Required", color: "text-brand-emerald bg-brand-emerald/10 border-brand-emerald/20" },
    { name: "Accessibility Standards (WCAG)", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "HIPAA-Aligned Design Guardrails", level: "Highly Valued", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "Interactive Prototyping", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS platforms", desc: "Formulate layout grids and workflows for clinicians managing patient registries.", icon: <Globe className="w-5 h-5" /> },
    { title: "Patient portal systems", desc: "Design intake cards, booking engines, and medication checklist features.", icon: <Users className="w-5 h-5" /> },
    { title: "Clinical workflow applications", desc: "Construct density-balanced dashboards to prevent doctor alert fatigue.", icon: <Layers className="w-5 h-5" /> },
    { title: "Telemedicine platforms", desc: "Refine video interface call controls, screen-sharing slots, and connection alerts.", icon: <HeartPulse className="w-5 h-5" /> },
    { title: "AI healthcare interfaces", desc: "Design interfaces explaining AI diagnostics data schemas clearly to providers.", icon: <Brain className="w-5 h-5" /> },
    { title: "Healthcare automation systems", desc: "Iterate on wizard steps that help clinic administrators deploy workflows.", icon: <Activity className="w-5 h-5" /> },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-cyan/15 to-brand-indigo/15 border border-brand-cyan/20 rounded-full px-4 py-1.5 shadow-lg shadow-brand-cyan/5">
                  ...
                  <span className="text-[10px] font-bold text-brand-cyan uppercase tracking-widest">Design Career</span>
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Design intuitive, user-friendly, and scalable healthcare digital products. Simplify complex clinical workflows and improve patient-care user experiences in the US.
                </p>
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Med Clinic X is a healthcare technology company building modern digital products that power healthcare organizations across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We design and develop healthcare SaaS platforms, patient portals, AI-powered healthcare systems, telemedicine solutions, automation tools, and digital health experiences for clinics, hospitals, and healthcare providers.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to simplify healthcare through intuitive, human-centered product design that improves both patient and clinician experiences.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are looking for a <strong>Product Designer</strong> to design intuitive, user-friendly, and scalable healthcare digital products.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will work across UX, UI, and product strategy to design healthcare SaaS platforms, patient portals, clinical workflows, and AI-driven healthcare tools used across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will collaborate closely with product managers, engineers, AI teams, and healthcare stakeholders to create seamless digital experiences that improve healthcare delivery.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Product Design & UX</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Design user-friendly interfaces for SaaS platforms.</li>
                        <li>Create wireframes, prototypes, and high-fidelity UIs.</li>
                        <li>Improve patient and clinician user experiences.</li>
                        <li>Translate complex clinical workflows into simple screens.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Healthcare Products</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Design patient portals and telemedicine interfaces.</li>
                        <li>Structure intuitive dashboard data tables.</li>
                        <li>Collaborate on AI-driven feature interface designs.</li>
                        <li>Verify usability in active hospital settings.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Research & Testing</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Conduct research with providers and patients.</li>
                        <li>Analyze behavioral flows to trace bottlenecks.</li>
                        <li>Draft patient-journey mapping schematics.</li>
                        <li>Validate designs with quantitative usability tests.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Design Consistency</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Deploy and align reusable Figma design tokens.</li>
                        <li>Ensure alignment with WCAG accessibility standards.</li>
                        <li>Support engineering teams with clean specs handover.</li>
                        <li>Ensure brand identity consistency across applications.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will design products that directly improve how healthcare is delivered and experienced. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Design real healthcare products used by clinics and hospitals</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Work on AI-powered and data-driven healthcare interfaces</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Collaborate with engineering, product, and clinical teams</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Shape the future of human-centered healthcare design</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Thank you for demonstrating your accessibility and security compliance design choices. This simulation reflects our dedication to building clean, HIPAA-compliant interfaces.
                        </p>
                      </div>
                    ...
                    <>
                      ...
                      {formStep === 1 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">LinkedIn or Dribbble/Behance URL</label>
                              <input
                                type="url"
                                value={formData.portfolioUrl}
                                onChange={(e) => setFormData(prev => ({ ...prev, portfolioUrl: e.target.value }))}
                                placeholder="https://dribbble.com/claras"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">Design & UX Experience</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary Design Tool</label>
                              <select
                                value={formData.designTool}
                                onChange={(e) => setFormData(prev => ({ ...prev, designTool: e.target.value }))}
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of experience in digital product design</label>
                              <select
                                value={formData.designYears}
                                onChange={(e) => setFormData(prev => ({ ...prev, designYears: e.target.value }))}
                                className="w-full bg-brand-bg border border-brand-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan transition-colors"
                              >
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable design-reviewing clinical dashboards for HIPAA compliance constraints (screen privacy)?</label>
                              <div className="flex gap-4">
                                {["yes", "no"].map((val) => (
                                  <button
                                    key={val}
                                    type="button"
                                    onClick={() => setFormData(prev => ({ ...prev, hipaaUXComfort: val }))}
                                    className={`flex-1 border text-sm font-semibold py-2.5 rounded-xl capitalize transition-all cursor-pointer ${
                                      formData.hipaaUXComfort === val
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">Product Design Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">Design Tool:</span>{" "}
                                <span className="capitalize">{formData.designTool}</span>
                              </p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">Design Experience:</span> {formData.designYears} years</p>
                            ...
                            >
                              {isSubmitting ? (
                                <>
                                  ...
                                  <span>Testing prototypes...</span>
                                </>
                              ) : (
                                <>
                                  <Send className="w-3.5 h-3.5" />
                                  <span>Submit Designer Application</span>
                                </>
                              )}
                            </button>
                          </div>
