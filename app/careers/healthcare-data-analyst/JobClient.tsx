                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed max-w-md mx-auto">
                        Thank you for applying, <strong className="text-white">{formData.name}</strong>. Your profile has passed our automated screening checks. Our engineering and healthcare product recruitment team will review your application within 24 hours.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-900/60 p-4 rounded-xl border border-brand-border max-w-sm mx-auto text-left space-y-2 font-mono text-xs">
                      ...
                      <p className="text-gray-400">Position: <span className="text-white">Healthcare Data Analyst</span></p>
                      <p className="text-gray-400">SQL Screener: <span className="text-brand-emerald">100% Passed</span></p>
                      <p className="text-gray-400">US Healthcare fit: <span className="text-brand-cyan">Highly Compatible</span></p>
                      <p className="text-gray-400">Status: <span className="text-brand-emerald animate-pulse">Under Clinical Team Review</span></p>
                    </div>
