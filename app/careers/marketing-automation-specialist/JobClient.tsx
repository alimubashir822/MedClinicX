...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "CRM Platforms (HubSpot/Salesforce)", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "Email Automation & Sequences", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    { name: "Funnel & Workflow Design", level: "Required", color: "text-brand-emerald bg-brand-emerald/10 border-brand-emerald/20" },
    { name: "Marketing Analytics & KPIs", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "Basic SQL & Data Analysis", level: "Required", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "Server-Side Tracking & APIs", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS Marketing Systems", desc: "Build lead generation funnels targeting hospital decision-makers.", icon: <Globe className="w-5 h-5" /> },
    { title: "Patient Engagement Automation", desc: "Design post-onboarding email sequences to increase portal adoption.", icon: <Layers className="w-5 h-5" /> },
    { title: "CRM & Lead Management", desc: "Configure sales pipelines, custom properties, and webhook triggers.", icon: <Database className="w-5 h-5" /> },
    { title: "Healthcare Growth Funnels", desc: "Track conversions safely across patient acquisition landing pages.", icon: <Activity className="w-5 h-5" /> },
    { title: "AI-Powered Marketing Workflows", desc: "Implement automated content personalization pipelines based on lead tiers.", icon: <Sparkles className="w-5 h-5" /> },
    { title: "Telemedicine Acquisition Funnels", desc: "Route registration flows and optimize lead routing parameters.", icon: <Server className="w-5 h-5" /> },
  ];
    ...
    <div className="relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="mb-8 flex items-center space-x-2 text-xs">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-white">Marketing Automation Specialist</span>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-cyan/15 to-brand-indigo/15 border border-brand-cyan/20 rounded-full px-4 py-1.5 shadow-lg shadow-brand-cyan/5">
                  ...
                  <span className="text-[10px] font-bold text-brand-cyan uppercase tracking-widest">Growth Automation</span>
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Design, build, and optimize automated marketing systems, HIPAA-compliant CRM pipelines, and data-driven patient engagement workflows.
                </p>
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Med Clinic X is a healthcare technology company building modern digital growth systems that help healthcare organizations across the United States connect with patients and improve engagement.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We develop healthcare SaaS platforms, AI-driven healthcare systems, patient portals, telemedicine solutions, automation workflows, and digital marketing systems that support clinics, hospitals, and healthcare providers.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to build intelligent automation systems that streamline patient acquisition, engagement, and retention.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are seeking a <strong>Marketing Automation Specialist</strong> to design, build, and optimize automated marketing systems that drive growth for healthcare SaaS products.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will develop CRM workflows, email automation, lead nurturing funnels, and data-driven marketing systems targeting healthcare organizations across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will work closely with marketing, sales, and product teams to improve lead generation and conversion performance.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Marketing Automation & CRM</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Build and manage automated marketing workflows.</li>
                        <li>Design CRM pipelines for healthcare SaaS lead management.</li>
                        <li>Develop email marketing sequences and drip campaigns.</li>
                        <li>Optimize lead nurturing and conversion funnels.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Healthcare Growth Systems</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Create automation systems for patient and client acquisition.</li>
                        <li>Support marketing campaigns for healthcare SaaS products.</li>
                        <li>Improve engagement and retention through automation strategies.</li>
                        <li>Analyze marketing performance and optimize workflows.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Data & Performance</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Track campaign performance and conversion metrics.</li>
                        <li>Segment audiences based on behavior and engagement.</li>
                        <li>Optimize funnels using data-driven insights.</li>
                        <li>Improve ROI across marketing channels.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Work with sales, product, and growth teams.</li>
                        <li>Align automation systems with business goals.</li>
                        <li>Support CRM integration with SaaS platforms.</li>
                        <li>Ensure seamless data flow across marketing systems.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-300">
                    <div className="space-y-3">
                      ...
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        <li>Bachelor’s degree in Marketing, Business, CS, or related field.</li>
                        <li>Experience in marketing automation or CRM platform administration.</li>
                        <li>Strong understanding of email marketing and lead nurturing.</li>
                        <li>Hands-on experience with CRM tools (HubSpot, Salesforce, etc).</li>
                        <li>Strong analytical mind and comfort with funnel performance metrics.</li>
                      </ul>
                    </div>
                    <div className="space-y-3">
                      <h3 className="font-semibold text-white text-xs uppercase tracking-wider text-brand-indigo">Preferred</h3>
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        <li>Experience in US healthcare or healthcare SaaS B2B environments.</li>
                        <li>Familiarity with HIPAA constraints regarding marketing data.</li>
                        <li>Experience building workflow webhooks or API CRM triggers.</li>
                        <li>Exposure to marketing lifecycle analytics dashboards.</li>
                        <li>Experience in scaling startup SaaS lead pipelines.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will build automation systems that directly drive growth for healthcare technology products. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Build marketing automation systems for US healthcare SaaS</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Improve patient and client acquisition funnels</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Work with modern CRM and growth tools</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Drive measurable impact on business growth</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Your CRM growth configuration score is logged. We verified your HIPAA-compliant CRM segmentation parameters, multi-channel sms routing logic, and server-side webhook analytics.
                        </p>
                      </div>
                    ...
                    <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="laura.marketing@example.com"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="https://linkedin.com/in/lauragrowth"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">CRM & Growth Profile</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary CRM Platform</label>
                              <select
                              ...
                              >
                                <option value="hubspot">HubSpot CRM & Marketing Hub</option>
                                <option value="salesforce">Salesforce Marketing Cloud</option>
                                <option value="marketo">Adobe Marketo Engage</option>
                                <option value="activecampaign">ActiveCampaign</option>
                              </select>
                            </div>

                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of Marketing Automation Experience</label>
                              <select
                                value={formData.marketingYears}
                                onChange={(e) => setFormData(prev => ({ ...prev, marketingYears: e.target.value }))}
                                className="w-full bg-brand-bg border border-brand-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan transition-colors"
                              >
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable configuring event-based tracking webhooks to CRM tables?</label>
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">Growth Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">CRM:</span>{" "}
                                <span className="capitalize">{formData.primaryCRM}</span>
                              </p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">Experience:</span> {formData.marketingYears} years</p>
                            ...
                            >
                              {isSubmitting ? (
                                <>
                                  ...
                                  <span>Submitting campaigns...</span>
                                </>
                              ) : (
                                <>
