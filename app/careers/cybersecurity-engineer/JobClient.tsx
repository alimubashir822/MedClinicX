...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "Cloud Infrastructure Security", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "Application Security & Code Reviews", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    { name: "HIPAA Security Auditing", level: "Required", color: "text-brand-emerald bg-brand-emerald/10 border-brand-emerald/20" },
    { name: "SIEM Threat Detection & Monitoring", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "Identity Access Management (IAM)", level: "Highly Valued", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "DevSecOps CI/CD security integration", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS platforms", desc: "Build network security boundaries and secure API endpoints.", icon: <Globe className="w-5 h-5" /> },
    { title: "Cloud-based clinical systems", desc: "Audit container orchestration security standards in AWS/Azure clusters.", icon: <Layers className="w-5 h-5" /> },
    { title: "Patient data security", desc: "Deploy cryptographic keys and encryption policies for electronic health records.", icon: <Lock className="w-5 h-5" /> },
    { title: "Telemedicine platforms", desc: "Audit video stream authentication handshakes and media encryption keys.", icon: <HeartPulse className="w-5 h-5" /> },
    { title: "AI healthcare systems", desc: "Implement data-loss prevention rules to protect clinical outcomes databases.", icon: <Brain className="w-5 h-5" /> },
    { title: "Healthcare APIs & data pipelines", desc: "Scan ingress hooks and verify token authentications on dynamic web services.", icon: <Code className="w-5 h-5" /> },
  ];
    ...
    <div className="relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="mb-8 flex items-center space-x-2 text-xs">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-white">Cybersecurity Engineer</span>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Design, implement, and maintain security systems that protect healthcare SaaS platforms and sensitive patient data. Secure cloud infrastructure and clinical APIs.
                </p>
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Med Clinic X is a healthcare technology company building secure, modern digital health systems that support healthcare organizations across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to ensure every healthcare system we build is secure, compliant, and resilient against modern cyber threats.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are seeking a <strong>Cybersecurity Engineer</strong> to design, implement, and maintain security systems that protect healthcare SaaS platforms and sensitive patient data.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will safeguard cloud infrastructure, applications, APIs, and healthcare data systems used across the United States. You will work closely with engineering, DevOps, and cloud teams to ensure strong security posture across all Med Clinic X products.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will play a critical role in protecting patient data and ensuring compliance with healthcare security standards.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Healthcare Security</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Secure healthcare SaaS platforms, APIs, and networks.</li>
                        <li>Protect patient records and private database schemas.</li>
                        <li>Audit system vulnerabilities and design fixes.</li>
                        <li>Monitor networks for threat incursions or anomalies.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Cloud & Application Safety</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Implement security controls in AWS, Azure, or GCP.</li>
                        <li>Secure containerized nodes and Kubernetes setups.</li>
                        <li>Execute application penetration tests and code audits.</li>
                        <li>Enforce DevSecOps parameters in build pipelines.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Compliance & Governance</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Align platform setups with HIPAA security rules.</li>
                        <li>Audit dynamic access controls & identity configurations.</li>
                        <li>Lead compliance audits and prepare security proofs.</li>
                        <li>Maintain security documentation profiles.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Threat Detection</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Audit security alert feeds and logs in SIEM (Splunk).</li>
                        <li>Manage incident response workflows and recovery steps.</li>
                        <li>Build automated alerting systems for compliance breaches.</li>
                        <li>Review threat modeling profiles across engineering.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will help protect the core systems that power modern healthcare delivery. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Secure real healthcare systems used by US providers</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Protect sensitive patient and clinical data</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Work directly with cloud, AI, and software engineering teams</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Build enterprise-grade healthcare security systems</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Thank you for demonstrating your healthcare cybersecurity, firewall architecture, and token rotation skills.
                        </p>
                      </div>
                    ...
                    <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="https://github.com/reginac"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">Security & Certifications Experience</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary Security Certification</label>
                              <select
                                value={formData.primaryCert}
                                onChange={(e) => setFormData(prev => ({ ...prev, primaryCert: e.target.value }))}
                              ...
                              >
                                ...
                                <option value="security_plus">CompTIA Security+</option>
                                <option value="none">No Professional Security Certification</option>
                              </select>
                            </div>

                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of experience in cybersecurity or cloud security</label>
                              <select
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable design-reviewing clinical software architectures for HIPAA Security compliance rules?</label>
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">Cybersecurity Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">Certification:</span>{" "}
                                <span className="uppercase">{formData.primaryCert}</span>
                              </p>
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  ...
                                  <span>Submit Security Application</span>
                                </>
                              )}
                            </button>
                          </div>
