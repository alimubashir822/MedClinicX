...
export default function JobClient() {
  ...
  const technicalSkills: TechSkill[] = [
    { name: "Cloud Platform Security (AWS/Azure/GCP)", level: "Required", color: "text-brand-cyan bg-brand-cyan/10 border-brand-cyan/20" },
    { name: "IAM & Role-Based Access Controls", level: "Required", color: "text-brand-indigo bg-brand-indigo/10 border-brand-indigo/20" },
    { name: "SIEM log monitoring (Splunk/ELK)", level: "Required", color: "text-brand-emerald bg-brand-emerald/10 border-brand-emerald/20" },
    { name: "Container security (Docker/K8s)", level: "Required", color: "text-purple-400 bg-purple-400/10 border-purple-400/20" },
    { name: "KMS Cryptographic Key Management", level: "Highly Valued", color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "DevSecOps CI/CD security gating", level: "Preferred", color: "text-rose-400 bg-rose-400/10 border-rose-400/20" },
  ];

  const techAreas: TechArea[] = [
    { title: "Healthcare SaaS Platforms", desc: "Configure ingress filtering rules and secure API paths connecting hospital nodes.", icon: <Globe className="w-5 h-5" /> },
    { title: "Cloud-Based Clinical Systems", desc: "Audit container orchestration boundaries and host networking configurations.", icon: <Database className="w-5 h-5" /> },
    { title: "Patient Data Security Systems", desc: "Establish encryption-at-rest policies on patient databases and backup nodes.", icon: <Lock className="w-5 h-5" /> },
    { title: "EHR/EMR Integrations", desc: "Scan integration queues and encrypt API keys used by external health portals.", icon: <Users className="w-5 h-5" /> },
    { title: "AI Healthcare Infrastructure", desc: "Harden GPU clusters and secure pipeline inputs feeding into medical NLP models.", icon: <Brain className="w-5 h-5" /> },
    { title: "Digital Health Cloud Ecosystems", desc: "Conduct automated security audits to verify HIPAA and HITRUST compliance rules.", icon: <Server className="w-5 h-5" /> },
  ];
  ...
  const validateSandbox = () => {
    ...
    // Correct choices:
    // networkIngress -> waf_alb_block
    // secretsManagement -> secrets_manager_kms
    // containerSecurity -> trivy_scan_block
    
    const correctIngress = sandboxSetup.networkIngress === "waf_alb_block";
    const correctSecrets = sandboxSetup.secretsManagement === "secrets_manager_kms";
    const correctContainer = sandboxSetup.containerSecurity === "trivy_scan_block";
    
    if (correctIngress && correctSecrets && correctContainer) {
      ...
      if (!correctSecrets) incorrectCount++;
      if (!correctContainer) incorrectCount++;
      
      setSandboxError(
        `Cloud hardening validation failed. ${incorrectCount}/3 security settings contain compliance gaps. Hint: Force public traffic through a WAF/ALB filter block; leverage AWS Secrets Manager with customer KMS key rotation for database credentials; and trigger vulnerability checks (Trivy) in CI builds to fail if CRITICAL CVEs are discovered.`
      );
    }
  };
    ...
    <div className="relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="mb-8 flex items-center space-x-2 text-xs">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-white">Cloud Security Engineer</span>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-8 space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-cyan/15 to-brand-indigo/15 border border-brand-cyan/20 rounded-full px-4 py-1.5 shadow-lg shadow-brand-cyan/5">
                  ...
                  <span className="text-[10px] font-bold text-brand-cyan uppercase tracking-widest">Security Career</span>
                ...
                <p className="text-sm md:text-base text-gray-300 max-w-2xl leading-relaxed">
                  Design, implement, and maintain secure cloud environments for healthcare SaaS platforms and clinical databases. Protect patient data, implement DevSecOps triggers, and enforce HIPAA cloud configs.
                </p>
              ...
              >
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Med Clinic X is a healthcare technology company building secure, cloud-native digital health systems for healthcare organizations across the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We develop healthcare SaaS platforms, AI-powered healthcare systems, patient portals, telemedicine solutions, automation workflows, and scalable cloud-based digital health infrastructure.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Our mission is to ensure every healthcare system we build is secure, compliant, and resilient against evolving cyber threats.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    We are seeking a <strong>Cloud Security Engineer</strong> to design, implement, and maintain secure cloud environments for healthcare SaaS platforms and digital health systems.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    In this role, you will protect sensitive healthcare data, secure cloud infrastructure, and ensure compliance across AWS, Azure, or GCP environments used by healthcare organizations in the United States.
                  </p>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    You will collaborate closely with DevOps, cloud engineers, and software teams to build secure-by-design healthcare systems.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Cloud Security & Protection</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Secure cloud infrastructure for healthcare SaaS.</li>
                        <li>Protect patient databases and clinical APIs from threats.</li>
                        <li>Implement active security controls across AWS/Azure platforms.</li>
                        <li>Monitor and resolve security incidents in real time.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">DevSecOps & CI/CD Gating</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Integrate security scanning checks into CI/CD release loops.</li>
                        <li>Perform secure threat reviews for database infrastructures.</li>
                        <li>Implement vulnerability scanning on container dependencies.</li>
                        <li>Automate cloud testing configurations using Terraform logs.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Compliance & Risk Audit</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Ensure cloud security compliance with HIPAA standards.</li>
                        <li>Enforce key rotations, data encryption, and access controls.</li>
                        <li>Provide reporting data to support compliance audits.</li>
                        <li>Assess and patch vulnerabilities across active cloud platforms.</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-panel border border-brand-border p-5 rounded-2xl space-y-2">
                      ...
                      <h3 className="font-semibold text-white text-sm">Threat Detection & Response</h3>
                      <ul className="text-xs text-gray-400 space-y-1.5 list-disc list-inside">
                        <li>Monitor system alerts and security logs via Splunk/ELK.</li>
                        <li>Investigate and respond to unauthorized ingress alerts.</li>
                        <li>Determine root causes and remediate system weaknesses.</li>
                        <li>Build proactive alerts for suspicious admin user roles.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-300">
                    <div className="space-y-3">
                      ...
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        <li>Bachelor’s degree in Cybersecurity, CS, Info Security, or related field.</li>
                        <li>Experience in cloud security, DevSecOps, or infrastructure protection.</li>
                        <li>Strong understanding of AWS, Azure, or GCP console environments.</li>
                        <li>Expertise in container security (Docker, Kubernetes/EKS).</li>
                        <li>Experience running SIEM tools (Splunk, ELK, AWS GuardDuty).</li>
                      </ul>
                    </div>
                    <div className="space-y-3">
                      <h3 className="font-semibold text-white text-xs uppercase tracking-wider text-brand-indigo">Preferred</h3>
                      <ul className="text-xs text-gray-400 space-y-2 list-disc list-inside">
                        <li>Experience securing US healthcare platforms or clinical SaaS.</li>
                        <li>Familiarity with HIPAA, HITRUST, or SOC 2 auditing protocols.</li>
                        <li>Experience deploying DevSecOps pipelines (GitHub Actions, GitLab CI).</li>
                        <li>Expertise with HashiCorp Vault, AWS KMS, or encryption systems.</li>
                        <li>Certifications such as CISSP, CCSP, or AWS Security Specialty.</li>
                      </ul>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-sm text-gray-300 leading-relaxed">
                    At Med Clinic X, you will help secure the systems that power modern healthcare delivery. You will:
                  </p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Protect real healthcare platforms used across the US</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Secure cloud-native SaaS and AI healthcare systems</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Work closely with elite engineering, DevOps, and product teams</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-brand-emerald shrink-0 mt-0.5" />
                      <span>Build enterprise-grade healthcare security and compliance controls</span>
                    </li>
                  </ul>
                </section>
              </motion.div>
                ...
                <div className="glass-panel border border-brand-border rounded-3xl p-6 md:p-8">
                  ...
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
                          Thank you for demonstrating your technical understanding of cloud VPC ingress boundaries, KMS secrets rotation, and Trivy build-gating scans.
                        </p>
                      </div>
                      ...
                      <button
                        onClick={() => {
                          ...
                          setSandboxSetup({ networkIngress: "", secretsManagement: "", containerSecurity: "" });
                          setFormData({
                            name: "",
                            email: "",
                            portfolioUrl: "",
                    ...
                    <>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="owen.sec@example.com"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="https://github.com/owensec"
                                className="w-full bg-brand-bg/50 border border-brand-border rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-cyan transition-colors"
                              />
                            </div>
                      ...
                      {/* STEP 2: Security Experience */}
                      {formStep === 2 && (
                        <div className="space-y-5">
                          <h3 className="font-display font-extrabold text-lg text-white">Cloud Security Profile</h3>
                          
                          <div className="space-y-4">
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Primary Cloud Platform Ecosystem</label>
                              <select
                                value={formData.primaryCloud}
                                onChange={(e) => setFormData(prev => ({ ...prev, primaryCloud: e.target.value }))}
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Years of Cloud Security / DevSecOps Experience</label>
                              <select
                                value={formData.securityYears}
                                onChange={(e) => setFormData(prev => ({ ...prev, securityYears: e.target.value }))}
                                className="w-full bg-brand-bg border border-brand-border rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan transition-colors"
                              >
                            ...
                            <div>
                              <label className="block text-xs font-semibold text-gray-300 mb-1.5">Are you comfortable writing customized OPA (Open Policy Agent) validation logic for Terraform templates?</label>
                      ...
                      {formStep === 3 && (
                        <div className="space-y-5">
                          <div className="flex justify-between items-start">
                            <div>
                              <h3 className="font-display font-extrabold text-lg text-white">HIPAA Cloud Hardening & DevSecOps Sandbox</h3>
                              <p className="text-xs text-gray-400 mt-1">
                                Secure the VPC ingress boundaries, secrets storage keys, and CI/CD container dependencies.
                              </p>
                            </div>
                          ...
                          <div className="space-y-4 font-sans text-xs">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-3">
                              <div className="font-mono text-white text-xs font-semibold flex items-center space-x-2">
                                ...
                                <span>Parameter 1: VPC Public Ingress Security</span>
                              </div>
                              <p className="text-gray-400 italic text-[11px] leading-relaxed">
                                &quot;How should public web traffic ingress to the clinical SaaS platform be configured at the VPC boundary?&quot;
                              </p>
                              <div>
                                <select
                                  value={sandboxSetup.networkIngress}
                                  onChange={(e) => setSandboxSetup(prev => ({ ...prev, networkIngress: e.target.value }))}
                                ...
                                >
                                  <option value="">-- Choose Ingress Policy --</option>
                                  <option value="waf_alb_block">Enforce AWS WAF rate-limits on an ALB and restrict hosts via security group whitelists (Correct!)</option>
                                  <option value="direct_igw">Route public internet traffic directly to ECS container hosts via an internet gateway</option>
                                  <option value="open_security_group">Open port 80/443 on the database subnet security group to allow sync operations</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-3">
                              <div className="font-mono text-white text-xs font-semibold flex items-center space-x-2">
                                ...
                                <span>Parameter 2: Database Credentials Secrets Storage</span>
                              </div>
                              <p className="text-gray-400 italic text-[11px] leading-relaxed">
                                &quot;Which secrets mapping method secures database login credentials used by API microservices?&quot;
                              </p>
                              <div>
                                <select
                                  value={sandboxSetup.secretsManagement}
                                  onChange={(e) => setSandboxSetup(prev => ({ ...prev, secretsManagement: e.target.value }))}
                                  className="w-full bg-brand-bg border border-brand-border rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-brand-cyan"
                                >
                                  <option value="">-- Choose Storage Method --</option>
                                  <option value="secrets_manager_kms">Store in Secrets Manager, encrypted via managed KMS key with auto-rotation every 30 days (Correct!)</option>
                                  <option value="env_var_plain">Inject credentials as plaintext environment variables inside the ECS Task Definition file</option>
                                  <option value="hardcoded_repo">Commit credentials directly to a private GitHub repository for direct reference</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-3">
                              <div className="font-mono text-white text-xs font-semibold flex items-center space-x-2">
                                ...
                                <span>Parameter 3: CI/CD Container Vulnerability Scans</span>
                              </div>
                              <p className="text-gray-400 italic text-[11px] leading-relaxed">
                                &quot;How should Docker containers be scanned and validated before cluster deployments?&quot;
                              </p>
                              <div>
                                <select
                                  value={sandboxSetup.containerSecurity}
                                  onChange={(e) => setSandboxSetup(prev => ({ ...prev, containerSecurity: e.target.value }))}
                                  className="w-full bg-brand-bg border border-brand-border rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-brand-cyan"
                                >
                                  <option value="">-- Choose Scanning Rule --</option>
                                  <option value="trivy_scan_block">Trigger Trivy scans in the CI build step, failing build if CRITICAL CVEs are found (Correct!)</option>
                                  <option value="periodic_audit">Deploy image immediately, scheduling security scans on containers once a month</option>
                                  <option value="bypass_internal">Scan public-facing web components only, bypassing scans on internal microservices</option>
                                </select>
                              </div>
                            </div>
                          </div>
                          ...
                          {sandboxSuccess && (
                            <div className="flex items-start space-x-2.5 p-3.5 bg-brand-emerald/10 border border-brand-emerald/20 text-brand-emerald rounded-xl text-xs">
                              ...
                              <span>Hardening parameters verified! WAF/ALB rate limits configured, customer KMS rotation active, and Trivy build-gating scans enabled.</span>
                            </div>
                          )}
                          ...
                          <div className="pt-4 flex justify-between">
                            ...
                            {!sandboxSuccess ? (
                              <button
                                ...
                                className="inline-flex items-center space-x-2 bg-brand-cyan text-brand-bg font-bold px-5 py-3 rounded-xl hover:opacity-90 transition-opacity text-xs cursor-pointer"
                              >
                                <span>Audit Cloud Hardening ({sandboxAttempts} attempts)</span>
                              </button>
                            ) : (
                              <button
                                type="button"
                      ...
                      {formStep === 4 && (
                        <div className="space-y-5">
                          ...
                          <div className="space-y-4 text-xs font-mono">
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-2">
                              <p className="text-gray-500 uppercase text-[10px] tracking-wider mb-2 font-bold font-sans">Cloud Security Profile</p>
                              <p className="text-gray-300">
                                <span className="text-gray-500 font-sans">Primary Cloud:</span>{" "}
                                <span className="capitalize">{formData.primaryCloud.toUpperCase()}</span>
                              </p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">Security Experience:</span> {formData.securityYears} years</p>
                              <p className="text-gray-300"><span className="text-gray-500 font-sans">Terraform OPA Comfort:</span> {formData.hipaaFamiliar}</p>
                            </div>
                            ...
                            <div className="bg-white/2 border border-white/5 p-4 rounded-xl space-y-1.5">
                              ...
                              <p className="text-brand-emerald flex items-center space-x-1.5">
                                ...
                                <span>WAF/ALB ingress, customer KMS database secrets rotation, and Trivy CI build-gating scans approved</span>
                              </p>
                            </div>
                          </div>
                            ...
                            >
                              {isSubmitting ? (
                                <>
                                  ...
                                  <span>Gating deployment...</span>
                                </>
                              ) : (
                                <>
                                  <Send className="w-3.5 h-3.5" />
                                  <span>Submit Cloud Security Application</span>
                                </>
                              )}
                            </button>
                          </div>
