...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/ckd-calculator/",
  },
  openGraph: {
    title: "CKD Calculator - Calculate Kidney Function & Understand Chronic Kidney Disease Risk | Med Clinic X",
    description:
...
export default function CKDCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "CKD Calculator", item: "https://medclinicx.com/calculator/ckd-calculator/" },
    ],
  };
