...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/stress-calculator/",
  },
  openGraph: {
    title: "Stress Calculator - Measure Stress Levels & Understand Mental Wellbeing Indicators | Med Clinic X",
    description:
...
export default function StressCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Stress Calculator", item: "https://medclinicx.com/calculator/stress-calculator/" },
    ],
  };
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-6 gap-4 mt-6">
                {[
                  ...
                  { name: "Fat Intake Calculator", path: "/calculator/fat-intake-calculator" },
                  { name: "Baby Growth Calculator", path: "/calculator/baby-growth-calculator" },
                  { name: "IV Flow Rate Calculator", path: "/calculator/iv-flow-rate-calculator" },
                  { name: "Infusion Calculator", path: "/calculator/infusion-calculator" }
                ].map((tool, index) => (
                  <Link 
                    key={index} 
                    href={tool.path}
