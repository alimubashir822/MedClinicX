...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/baby-age-calculator/",
  },
  openGraph: {
    title: "Baby Age Calculator - Calculate Your Baby’s Age in Weeks, Months & Years | Med Clinic X",
    description:
...
export default function BabyAgeCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Baby Age Calculator", item: "https://medclinicx.com/calculator/baby-age-calculator/" },
    ],
  };
