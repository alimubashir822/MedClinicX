...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/medication-dosage-calculator/",
  },
  openGraph: {
    title: "Medication Dosage Calculator - Calculate Medication Dosage Information Safely | Med Clinic X",
    description:
...
export default function MedDosageCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Medication Dosage Calculator", item: "https://medclinicx.com/calculator/medication-dosage-calculator/" },
    ],
  };
