...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/baby-weight-calculator/",
  },
  openGraph: {
    title: "Baby Weight Calculator - Estimate Your Baby’s Healthy Weight by Age | Med Clinic X",
    description:
...
export default function BabyWeightCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Baby Weight Calculator", item: "https://medclinicx.com/calculator/baby-weight-calculator/" },
    ],
  };
