...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/iv-drip-rate-calculator/",
  },
  openGraph: {
    title: "IV Drip Rate Calculator - Calculate IV Flow Rate, Drops Per Minute & Infusion Time | Med Clinic X",
    description:
...
export default function IVDripRateCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "IV Drip Rate Calculator", item: "https://medclinicx.com/calculator/iv-drip-rate-calculator/" },
    ],
  };
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-6 gap-4 mt-6">
                {[
                  ...
                  { name: "Glasgow Coma Scale Calculator", path: "/calculator/glasgow-coma-scale-calculator" },
