...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/baby-growth-calculator/",
  },
  openGraph: {
    title: "Baby Growth Calculator - Track Your Baby’s Growth, Height & Development Milestones | Med Clinic X",
    description:
...
export default function BabyGrowthCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Baby Growth Calculator", item: "https://medclinicx.com/calculator/baby-growth-calculator/" },
    ],
  };
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-6 gap-4 mt-6">
                {[
                  ...
                  { name: "Fetal Growth Calculator", path: "/calculator/fetal-growth-calculator" },
                  { name: "BMI Calculator", path: "/calculator/bmi-calculator" },
