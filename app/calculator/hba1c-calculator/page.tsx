...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://medclinicx.com/calculator/hba1c-calculator/",
  },
  openGraph: {
    title: "HbA1c Calculator - Estimate Your Blood Sugar Control & Average Glucose Level | Med Clinic X",
    description:
...
export default function HbA1cCalculatorPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "HbA1c Calculator", item: "https://medclinicx.com/calculator/hba1c-calculator/" },
    ],
  };
          ...
          <div className="border-t border-brand-border/40 pt-16 space-y-16 text-gray-300">
            ...
            <div className="border-t border-brand-border/40 pt-16 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-6 gap-4 mt-6">
                {[
                  { name: "Blood Glucose Calculator", path: "/calculator/a1c-calculator" },
